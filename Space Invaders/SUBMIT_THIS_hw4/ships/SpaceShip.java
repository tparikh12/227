...
public abstract class SpaceShip {
	...
	/**
	 * keeps track of the armorLevel
	 */
	protected int armorLevel;
	/**
	 * keeps track of the size of the bounding ring 
	 */
	protected BoundingRing size;
	protected long lastShotTime;
	public static final double HALO_SIZE = 10;
	/**
	 * game starts at max armor which is a contant 3
	 */
	public static int MAX_ARMOR = 3;
	/**
	 * a contant projectile speed which negativ beceuse it has to shoot down  
	 */
